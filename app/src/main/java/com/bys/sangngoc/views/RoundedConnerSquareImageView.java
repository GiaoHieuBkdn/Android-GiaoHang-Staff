...
public class RoundedConnerSquareImageView extends ImageView {
	...
	public RoundedConnerSquareImageView(Context context) {
		super(context);
	}

	public RoundedConnerSquareImageView(Context context, AttributeSet attrs) {
